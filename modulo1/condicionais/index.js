...
//código. Se ficar muito difícil, pode rodar no seu computador 
...
//a) Explique o que o código faz. Qual o teste que ele realiza?  Ele diz se o nr é par ou impar

//b) Para que tipos de números ele imprime no console 
//"Passou no teste"? Numeros Pares
...
/*a) Para que serve o código acima? Precificar as frutas

b) Qual será a mensagem impressa no console, se o valor de fruta for `"Maçã"`?
O preço da fruta maça é de R$ 2,25

c) Considere que um usuário queira comprar uma `Pêra`, qual seria a mensagem impressa
no console se retirássemos o `break` que está logo acima do `default` (o `break` 
indicado pelo comentário "BREAK PARA O ITEM c.")?
O preço da fruta Pêra é R$ 5,00 - ele assume o preço do default*/ 
...
/*a) O que a primeira linha está fazendo? Está pedindo para o usuário digitar um nr (já transformando
  o string em numero)

b) Considere um usuário digitou o número 10. Qual será a mensagem do terminal? esse numero passou no teste
 E se fosse o número -10? não aparece nada

c) Haverá algum erro no console? Justifique usando os conceitos de bloco ou escopo.
console.log(mensagem) não irá retornar nada*/
...
/* const periodo = prompt("Se estuda de manhã digite M, se estuda a tarde, digite V, se estuda a noite digite N")
if (periodo === "M"){
  console.log("Bom Dia!")
} else if (periodo === "V") {
...
const valorIngresso = prompt("Qual o valor do ingress?")
